...
public class LimelightLib {
    ...
    private static PoseEstimate getBotPoseEstimate(String limelightName, String entryName, boolean isMegaTag2) {
        DoubleArrayEntry poseEntry = LimelightLib.getLimelightDoubleArrayEntry(limelightName, entryName);
    ...
    public static RawFiducial[] getRawFiducials(String limelightName) {
        var entry = LimelightLib.getLimelightNTTableEntry(limelightName, "rawfiducials");
